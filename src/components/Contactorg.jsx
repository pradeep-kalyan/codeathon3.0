const Contactorg = ({ name, position, role, number , mail }) => {
  return (
    <div
      id="contact"
    ...
    >
      ...
      <h2 className="text-lg font-audio text-white/90">{position}</h2>
      <h2 className="text-lg font-audio text-gray-300">{role}</h2>
      <a
        href={`tel:${number}`}
